...
void bin_conv(
  ...
  #pragma HLS ARRAY_RESHAPE variable=line_buffer cyclic factor=2 dim=0
  #pragma HLS ARRAY_RESHAPE variable=conv_params complete
  #pragma HLS ARRAY_RESHAPE variable=fixed_buffer cyclic factor=4 dim=2
  #pragma HLS ARRAY_RESHAPE variable=fixed_temp cyclic factor=4 dim=1

  #pragma HLS ARRAY_RESHAPE variable=word_buffer cyclic factor=2 dim=0
  #pragma HLS ARRAY_RESHAPE variable=old_word_buffer cyclic factor=2 dim=0
  #pragma HLS ARRAY_RESHAPE variable=conv_out_buffer cyclic factor=4 dim=2
