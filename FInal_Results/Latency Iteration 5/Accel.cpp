...
void bin_conv(
  ...
  #pragma HLS ARRAY_MAP variable=line_buffer instance=tryVertical vertical
  #pragma HLS ARRAY_MAP variable=conv_params instance=tryVertical vertical
  #pragma HLS ARRAY_MAP variable=fixed_buffer instance=tryVertical vertical
  #pragma HLS ARRAY_MAP variable=fixed_temp instance=tryVertical vertical
  #pragma HLS ARRAY_MAP variable=word_buffer instance=tryVertical vertical
  #pragma HLS ARRAY_MAP variable=old_word_buffer instance=tryVertical vertical
