...
set ID 236
set hasByteEnable 0
set MemName bin_conv_fixed_bubkb
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dmem_V_2 \
    op interface \
    ports { dmem_V_2_address0 { O 12 vector } dmem_V_2_ce0 { O 1 bit } dmem_V_2_we0 { O 1 bit } dmem_V_2_d0 { O 64 vector } dmem_V_2_q0 { I 64 vector } dmem_V_2_address1 { O 12 vector } dmem_V_2_ce1 { O 1 bit } dmem_V_2_q1 { I 64 vector } } \
} "
} else {
