...
set out_width 14
set exp i0*i1+i2
set arg_lists {i0 {10 0 +} i1 {5 0 +} m {14 0 +} i2 {8 0 +} p {14 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set out_width 16
set exp i0*i1
set arg_lists {i0 {15 0 +} i1 {5 0 +} p {16 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 31
set hasByteEnable 0
set MemName bin_conv_line_bufcud
...
set ID 32
set hasByteEnable 0
set MemName bin_conv_conv_pardEe
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 1
set AddrRange 18
...
set ID 33
set hasByteEnable 0
set MemName bin_conv_fixed_bueOg
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 12
set AddrRange 2048
...
set ID 34
set hasByteEnable 0
set MemName bin_conv_fixed_tefYi
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 12
set AddrRange 64
...
set ID 35
set hasByteEnable 0
set MemName bin_conv_word_bufg8j
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 2
set AddrRange 160
...
set ID 36
set hasByteEnable 0
set MemName bin_conv_old_wordhbi
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 2
set AddrRange 160
...
set ID 37
set hasByteEnable 0
set MemName bin_conv_conv_outibs
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 5
set AddrRange 128
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_new_batch_V \
    op interface \
    ports { new_batch_V { I 1 vector } } \
} "
}
