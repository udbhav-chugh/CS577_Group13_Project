...
set ID 53
set hasByteEnable 1
set MemName fp_conv_outwords_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 64
set AddrRange 16
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_kh_index_V_2 \
    op interface \
    ports { kh_index_V_2 { I 1 vector } } \
} "
}
