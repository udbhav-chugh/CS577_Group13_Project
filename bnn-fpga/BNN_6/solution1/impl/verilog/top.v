...
(* CORE_GENERATION_INFO="top,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k70t-fbv676-1,HLS_INPUT_CLOCK=25.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=19.295250,HLS_SYN_LAT=5048,HLS_SYN_TPT=none,HLS_SYN_MEM=50,HLS_SYN_DSP=1,HLS_SYN_FF=3965,HLS_SYN_LUT=54770,HLS_VERSION=2019_1}" *)
...
wire   [0:0] trunc_ln880_fu_413_p1;
reg   [0:0] trunc_ln880_reg_832;
...
wire   [15:0] zext_ln812_fu_449_p1;
reg   [15:0] zext_ln812_reg_855;
...
wire   [15:0] select_ln827_fu_597_p3;
wire   [9:0] select_ln827_1_fu_605_p3;
...
wire   [4:0] zext_ln812_1_fu_453_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        zext_ln812_reg_855[2 : 1] <= zext_ln812_fu_449_p1[2 : 1];
...
assign r_V_fu_537_p2 = ret_V_8_fu_533_p1 << zext_ln812_reg_855;
...
assign select_ln827_1_fu_605_p3 = ((icmp_ln879_2_fu_586_p2[0:0] === 1'b1) ? 10'd0 : img_off_V_fu_580_p2);

assign select_ln827_fu_597_p3 = ((icmp_ln879_2_fu_586_p2[0:0] === 1'b1) ? img_idx_V_fu_591_p2 : p_0730_0_reg_318);
...
assign t_V_fu_421_p2 = (trunc_ln880_fu_413_p1 & p_Result_s_fu_403_p2);
...
assign trunc_ln880_fu_413_p1 = kh_index_V[0:0];

assign words_per_image_V_fu_457_p2 = 5'd1 << zext_ln812_1_fu_453_p1;

assign wt_i_V_address0 = zext_ln544_1_fu_692_p1;

assign xor_ln879_fu_718_p2 = (trunc_ln880_reg_832 ^ 1'd1);
...
assign zext_ln812_1_fu_453_p1 = shl_ln_fu_441_p3;

assign zext_ln812_fu_449_p1 = shl_ln_fu_441_p3;

assign zext_ln879_fu_469_p1 = words_per_image_V_fu_457_p2;

always @ (posedge ap_clk) begin
    zext_ln812_reg_855[0] <= 1'b0;
    zext_ln812_reg_855[15:3] <= 13'b0000000000000;
