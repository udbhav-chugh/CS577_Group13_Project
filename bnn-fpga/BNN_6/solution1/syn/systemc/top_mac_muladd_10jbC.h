...
// ==============================================================
#ifndef __top_mac_muladd_10jbC__HH__
#define __top_mac_muladd_10jbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mac_muladd_10jbC) {
    ...
    SC_CTOR(top_mac_muladd_10jbC):  simcore_mac_0_U ("simcore_mac_0_U") {
