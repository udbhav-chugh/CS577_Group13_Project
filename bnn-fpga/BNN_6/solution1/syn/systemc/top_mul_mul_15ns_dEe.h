...
// ==============================================================
#ifndef __top_mul_mul_15ns_dEe__HH__
#define __top_mul_mul_15ns_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_15ns_dEe) {
    ...
    SC_CTOR(top_mul_mul_15ns_dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
