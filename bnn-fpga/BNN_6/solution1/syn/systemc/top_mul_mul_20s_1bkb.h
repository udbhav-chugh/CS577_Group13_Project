...
// ==============================================================
#ifndef __top_mul_mul_20s_1bkb__HH__
#define __top_mul_mul_20s_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_20s_1bkb) {
    ...
    SC_CTOR(top_mul_mul_20s_1bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
