...
// ==============================================================
#ifndef __top_dmem_V_H__
#define __top_dmem_V_H__
...
struct top_dmem_V_ram : public sc_core::sc_module {
...
top_dmem_V_ram* meminst;


SC_CTOR(top_dmem_V) {
meminst = new top_dmem_V_ram("top_dmem_V_ram");
