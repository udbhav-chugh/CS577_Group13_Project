...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.top.autotvin_wt_i_V.dat"
         "c.top.autotvin_kh_i_V.dat"
         "c.top.autotvin_dmem_i_V.dat"
         "c.top.autotvin_dmem_o_V.dat"
         "c.top.autotvin_n_inputs_V.dat"
         "c.top.autotvin_n_outputs_V.dat"
         "c.top.autotvin_input_words_V.dat"
         "c.top.autotvin_output_words_V.dat"
         "c.top.autotvin_layer_mode_V.dat"
         "c.top.autotvin_dmem_mode_V.dat"
         "c.top.autotvin_width_mode_V.dat"
         "c.top.autotvin_norm_mode_V.dat"
         "c.top.autotvout_dmem_o_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.top.autotvout_dmem_o_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
